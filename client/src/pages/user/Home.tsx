        ...
        <div className="relative flex h-screen py-20 px-5 w-full items-center justify-center">
            ...
            <div className="flex flex-col w-full h-full gap-4 justify-center items-center relative z-10 max-w-md">
                <div className="w-full h-[40%] flex flex-row gap-4">
                    <Link to='/user/events' className="w-[60%] md:hover:scale-105 transition-transform ease-in-out duration-300 relative h-full border-white border-4 bg-[url('/pattern2.png')] bg-cover bg-center font-black">
                        ...
                        <img className='absolute bottom-3 right-0 transform -rotate-[58deg] translate-x-[30%]' src='/prop1.png' />
                    </Link>
                ...
                <div className="w-full h-[40%] flex flex-row gap-4">
                    <Link to='/user/orders' className="w-[45%] md:hover:scale-105 transition-transform ease-in-out duration-300 relative h-full border-white border-4 bg-[url('/pattern4.png')] bg-cover bg-center font-black">
                        ...
                        <img className='absolute bottom-0 left-0 transform scale-110 -rotate-[45deg] -translate-x-[25%] translate-y-[20%]' src='/prop3.png' />
                    </Link>
                    <Link to='/user/shop' className="w-[55%] md:hover:scale-105 transition-transform ease-in-out duration-300 relative h-full border-white border-4 bg-[url('/pattern5.png')] bg-cover bg-center font-black">
                        <div className="absolute flex flex-col top-3 left-3">
                        ...
                        <img className='absolute bottom-0 right-0 transform -rotate-[10deg] translate-x-[15%] translate-y-[10%]' src='/prop4.png' />
                    </Link>
                </div>
                <div className="w-full h-[20%] flex flex-row gap-4">
                    <Link to='/user/dashboard' className="w-[100%] md:hover:scale-105 transition-transform ease-in-out duration-300 relative h-full border-white border-4 bg-[url('/pattern6.png')] bg-cover bg-center font-black">
                        <div className="absolute flex flex-col top-3 left-3">
