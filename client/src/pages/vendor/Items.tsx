                ...
                !items?.length ? <p className="text-white text-center">No items created yet</p> :
                    items?.map((item: ItemSchema, index: number) => (
                        <div key={index} className="w-full h-[170px] md:h-[25%] flex flex-row gap-4">
                            <div className={`relative flex items-center justify-start w-[100%] md:hover:scale-105 transition-transform ease-in-out duration-300 h-full border-white border-4 bg-[url('https://i.imgur.com/AkXh4TV.png')] bg-cover bg-center`}>
                                ...
                                <div className="py-3 px-7 flex flex-col justify-center h-full">
                                    ...
                                    <div className="absolute right-2 bottom-2 flex-col flex gap-1">
                                        ...
                                        <Dialog>
                                            ...
                                            <DialogContent className="">
                                                <DialogHeader>
                                                    <DialogTitle className="leading-normal">Are you sure you want to delete this item?</DialogTitle>
                                                    <DialogDescription>
