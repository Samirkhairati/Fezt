                ...
                <div className="flex flex-col items-center gap-8 relative z-10 w-[70%] md:w-[400px]">
                    ...
                    <div className='h-[500px]  flex flex-col w-full flex-shrink-0 gap-10 mt-10'>
                        <div onClick={() => navigate('/login/user')} className="cursor-pointer w-full h-[150px] flex flex-row gap-4 opacity-80 hover:opacity-100 transition-opacity">
                            <div  className="items-center w-[100%] md:hover:scale-105 transition-transform ease-in-out duration-300 relative h-full border-white border-4 bg-[url('https://i.imgur.com/thNwZZQ.png')] bg-cover bg-center font-black">
                                <div className="w-full h-full flex items-center justify-center">
                                    <div className="text-5xl md:text-6xl text-white opacity-70">STUDENT</div>
                                </div>
                                <img className='absolute bottom-0 right-0 transform h-full w-auto rotate-[0deg] translate-x-[50%] scale-100 translate-y-[20%]' src='https://i.imgur.com/l0Avezw.png' />
                        ...
                        <div onClick={() => navigate('/login/vendor')} className="cursor-pointer w-full h-[150px] flex flex-row gap-4 opacity-80 hover:opacity-100 transition-opacity">
                            <div  className="w-[100%] md:hover:scale-105 transition-transform ease-in-out duration-300 relative h-full border-white border-4 bg-[url('https://i.imgur.com/kfZRxhl.png')] bg-cover bg-center font-black">
                                <div className="w-full h-full flex items-center justify-center">
                                    <div className="text-5xl md:text-6xl text-white opacity-70">VENDOR</div>
                                </div>
                                <img className='absolute bottom-0 right-0 transform h-full w-auto rotate-[20deg] translate-x-[50%] scale-125 translate-y-[20%]' src='https://i.imgur.com/uKfTVTD.png' />
                            </div>
                        </div>
                    </div>
